...
\begin{figure}[h!]
	\centering
	\includegraphics[width=.9\textwidth]{Figures/Cap_3/diagramaTareaOut}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=.9\textwidth]{Figures/Cap_3/diagramaTareaShell}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=.9\textwidth]{Figures/Cap_3/diagramaTareaLogs}
	\caption{Diagrama de estados de la tarea manejo de datos en memoria.}
	\label{fig:diag_TareasLogs}
\end{figure}

% Esta no deberia de hacer falta..........
La figura \ref{fig:diag_InterTaskLogs} muestra como interactúa entre las demás tareas.
% Colocar diagrama de estados
\begin{figure}[h!]
	\centering
	\includegraphics[width=.9\textwidth]{Figures/Cap_3/diagramaIntertareasLog}
