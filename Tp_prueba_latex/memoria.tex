...
%----------------------------------------------------------------------------------------
% Comando: Referencia
\thesistitle{ Sistema de Control para Galvanoplastia de PCBs } 
% \ttitle: El títulos de la memoria. 
\supervisor{ Ing. Juan Manuel Cruz } 
...
\juradoUNO{ Esp. Ing. Jorge Fonseca (pertenencia) } 
% \jur1name: Nombre y pertenencia del un jurado 1. 
\juradoDOS{ Esp. Ing. Diego Brengi (pertenencia) } 
% \jur2name: Nombre y pertenencia del un jurado 2.
\juradoTRES{ Esp. Ing. Ramiro Alonso (pertenencia) } 
