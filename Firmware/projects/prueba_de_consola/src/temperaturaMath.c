...
#define ERROR_TEMP			OFFSET_KELVIN
 ...
 * @param dR resitencia medida en ohms.
 * @param dCoeff coeficientes de la ecuacion de Steinhart.
 * @return valor de temperatura en grados Kelvin.
 */
volt_t tcuplaKVoltToTemp (volt_t dVolt, temp_t dTempRef)
{
	volt_t volt_ref= ERROR_TEMP;
 ...
 * @return valor de temperatura en grados Kelvin.
 */
volt_t tcuplaKTempToVolt (volt_t dVolt, temp_t dTempRef)
{
	volt_t volt_ref= ERROR_TEMP;
